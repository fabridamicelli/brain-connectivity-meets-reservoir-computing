...
param_grid = dict(
    ...
    spectral_radius=np.arange(90, 101, 2) * 0.01,
    leak_rate=[0.6, 0.8, 1],
    input_scaling=[0.001, 0.01, 0.1, 0.2, 0.5, 0.75, 1, 1.25],
    #   bias=[0, 1],
...
for connectome in AVAILABLE_CONNECTOMES:
    ...
    for _ in range(n_samples):
        ...
        result = (
            GridSearchTask(SequenceMemory, task_params, param_grid, verbose=0, n_jobs=2)
            .fit()
            .to_dataframe()
        )
